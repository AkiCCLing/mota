...
class YellowDoor(Door):
    def __init__(self, floor, x , y):
        ...
        self.images = []
        for i in range(1, 5):
            self.images.append(pygame.image.load('images/yellowdoor_0'+str(i)+'.png').convert_alpha())
...
class SpecialDoor(Door):
    def __init__(self, floor, x , y):
        ...
        self.images = []
        for i in range(1, 5):
            self.images.append(pygame.image.load('images/specialdoor_0'+str(i)+'.png').convert_alpha())
